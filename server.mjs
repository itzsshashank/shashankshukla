...
<html lang="en">
  ...
  <body>
    <header class="site-header"><div class="wrap bar"><a class="brand" href="/">Shashank Shukla</a><nav class="nav"><a href="/">Home</a><a href="/blogs/">All Posts</a></nav></div></header>
    <main>${body}</main>
...
async function readPosts() {
  try {
    ...
    for (const file of files.filter((name) => name.endsWith('.md'))) {
      ...
      posts.push({ file, slug, title, description, publishedAt, sourcePath: `/blogs/${file}`, url: `/blogs/${slug}/` });
    }
